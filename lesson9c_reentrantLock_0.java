...
public class lesson9c_reentrantLock_0 {
...
//		finally {lock.unlock();}
	...
	public  void secondThread() throws InterruptedException{
		...
		increment(); 
		// rather put this into a try catch
		// if increments throw an error then the unlock will never run
		// but if you use a try catch, then the try swollows the error and runs the finally
		// like this: try {increment();} finally {lock.unlock()}
		lock.unlock();
		// only one thread can lock at a time
	}  
